...
public class CarTransport extends AbstractTruck{
    ...
    boolean rampUp;                                  /** Whether the ramp ur raised or lowered */
    Stack<AbstractCar> transported = new Stack<>();  /** Stack of cars representing the cars loaded on the transport */
